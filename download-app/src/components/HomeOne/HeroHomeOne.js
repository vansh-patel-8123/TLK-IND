                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="appie-hero-content">
                                <span>Welcome To Fincept</span>
                                <h1 className="appie-title">
                                    Achieve your financial freedom with us
                                </h1>
                                <p>Financial planning is no more a headache join us and</p>
                                <p>improve your wealth management techniques with our tools.</p>
                                <ul>
                                    <li>
