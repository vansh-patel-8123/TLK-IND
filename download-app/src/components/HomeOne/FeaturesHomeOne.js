                        ...
                        <div className="appie-features-tabs-btn">
                            ...
                            >
                                <a
                                    ...
                                    aria-selected="true"
                                >
                                    <i className="fas fa-cog" /> Earn High Interest
                                </a>
                                <a
                                    ...
                                    aria-selected="false"
                                >
                                    <i className="fas fa-exclamation-triangle" /> Expense Tracker
                                </a>
                                <a
                                    ...
                                    aria-selected="false"
                                >
                                    <i className="fas fa-bell" /> Financial Literacy
                                </a>
                                <a
                                    ...
                                    aria-selected="false"
                                >
                                    <i className="fas fa-lock" /> World Economic Engine
                                </a>
                            </div>
                        </div>
                    </div>
